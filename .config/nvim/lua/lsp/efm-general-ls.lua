...
local isort = {formatCommand = "/usr/bin/isort --quiet -", formatStdin = true}
local black = {formatCommand = "/usr/bin/black --fast -", formatStdin = true}
...
if O.python.formatter == 'black' then table.insert(python_arguments, black) end
...
require"lspconfig".efm.setup {
    ...
    filetypes = {
        "lua", "python", "javascriptreact", "javascript", "typescript", "sh", "html", "css", "json", "yaml", "markdown",
        "vue"
    },
    settings = {
        languages = {
